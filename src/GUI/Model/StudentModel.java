...
public class StudentModel {
    ...
    /**
     * checks if there is an instance of the class, if there is it returns the instance
     * if there isn't, it creates an instance of it, and returns it 
     *
     * @return
     */
    ...
    /**
     * Constructs a new StudentManager and creates an observable arraylist of
     * class Student.
     */
    ...
    /**
     * Adds name and current class to the observable arraylist Student.
     *
     * @param name
     * @param currentClass
     * @param absence
    ...
    /**
     * Reads from the saved file on the computer. The saved file is specified
     * through FileChooser in TeacherViewController.
     *
     * @param file
     * @throws IOException
