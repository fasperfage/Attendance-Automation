...
public class TeacherViewController implements Initializable {
    ...
    /**
     * This method constructs the checkboxes in colAttendance. A listener is
     * added to be able to register, when a checkbox is checked.
     */
    ...
    /**
     * Opens FileChooser to make it possible for teachers to save a file using a
     * desired name. Data from Present, Class and Attendance are stored.
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Opens FileChooser and gives the posibility to choose a file. You can load
     * data into tblPresent.
     *
     * @param event
     */
    @FXML
